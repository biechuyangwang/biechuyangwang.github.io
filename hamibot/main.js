//初始化
auto.waitFor();
threads.start(function () { // 自动确认允许截图权限
  var beginBtn;
...
const token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE2ODIwNTk5NDgsInVpZCI6MTIyOTQ2NjU4LCJ2ZXIiOiIxIiwiZXh0IjoiMzYzMzMyNjMzMzY0MzgzODMxNjMzNjM5MzIzMjM1MzczOTMxNjQ2MzM4MzQzOTY2IiwiY29kZSI6IjRiN2M0YTVhZDIyY2JlZDFmMmQ1ODRkZGEwYjk2OTQ0IiwiZW5kIjoxNjgyMDU5OTQ4NzMxLCJwbGEiOjF9.Z7wGs45DbSohSsYRdHLssX0__Lu85ilI8-5j-snmsFQ";
var res = http.get("https://cat-match.easygame2021.com/sheep/v1/game/skin/info?", {
    headers: {
...
if(res.statusCode != 200){
    ...
    var content = res.body.json().data.skin_list.map((skin)=>console.log(getSkinName(skin.id)));
}